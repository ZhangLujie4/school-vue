...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    created() {
      var _this = this
      getItem('/class/schedule/'+_this.detail.classId).then(function (res) {
